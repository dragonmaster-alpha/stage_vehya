                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="position-relative p-3 bg-gray" style="height: 400px;">
                        ...
                        <p class="text-center"><img src="{{env('APP_URL')}}public/dist/img/thankyou.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"></p>
                        <p class="text-center big"><big><b> <a  href="{{env('APP_URL')}}admin/login"><button class="btn btn-success"><b>Go to Login</b></button> </a></b></big></p>
                    </div>
                  </div>
