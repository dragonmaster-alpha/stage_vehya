              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$list['address']}}</td>
                    <td><img src="{{env('APP_URL').'public/uploads/image/'}}{{$list['profile_image']}}" width="50"></td>
                     <td>
                    <a href="customer-list-view/{{$list['id']}}"><button class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                    <a href="customer-list-show/{{$list['id']}}"><button class="btn btn-info"><i class="fas fa-edit"></i></button></a>
