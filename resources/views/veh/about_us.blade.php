                ...
                <div class="row align-items-center g-0 m-0">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="why-img p-0 pt-5 pb-lg-5">
                            ...
                            <img src="{{env('APP_URL')}}public/veh/assets/img/why-img.svg" class="default-img img-cover position-relative"
                    ...
                    <div class="col-lg-5 col-12 ms-auto">
                        ...
                        <div class="card-body">
                            ...
                            <h1 class="card-title russo-font">Who we are &#63;</h1>
                            ...
                            <a href="{{env('APP_URL')}}veh/about_us" class="btn bg-warning text-uppercase rounded-0 px-5 py-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                A thorough evaluation your EV chargers needed, permits required, and any electrical

                                upgrades necessary for a successful
