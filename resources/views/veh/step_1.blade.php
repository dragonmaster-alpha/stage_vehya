    ...
    <form id="regForm" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="tab col-12 mt-5">
        ...
        <div class="row ">
          ...
          <div class="col-md-6 col-sm-12 mt-2">
            <h6>LAST NAME</h6>
            <p><input type="text" name="lname" placeholder="Last Name" oninput="this.className = ''" value="@isset($commercial){{$commercial->lname}}@endisset{{old('lname')}}" required=""></p>
          </div>
          <div class="col-md-6 col-sm-12 mt-2">
            <h6>EMAIL</h6>
          ...
          <div class="col-md-6 col-sm-12 mt-2">
            <h6>PHONE NUMBER</h6>
            <p>
                <input type="number" name="mobile_number" min="1000000000" max="9999999999"  placeholder="Enter Mobile Number" value="@isset($commercial){{$commercial->mobile_number}}@endisset{{old('mobile_number')}}" oninput="this.className = ''" required="">
            </p>
          </div>
          <div class="col-md-6 col-sm-12 mt-2">
            <h6>State</h6>
            <p>
                <select name="state" oninput="this.className = ''" required onchange="getcity()" id="states">
                      ...
                      <option value="<?php print_r($state->id); ?>"  @isset($commercial) @if($commercial->state == $state->id) selected @endif @endisset @if(old('state') == $state->id) selected @endif>{{$state->name}}</option>
                      @endforeach
                </select>
            </p>
          </div>
          <div class="col-md-6 col-sm-12 mt-2">
            <h6>CITY</h6>
            <p><input type="text" name="city" placeholder="City" oninput="this.className = ''" value="@isset($commercial){{$commercial->city}}@endisset{{old('city')}}" required=""></p>
          </div>
          <div class="col-md-6 col-sm-12 mt-2">
