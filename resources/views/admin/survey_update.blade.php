        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{env('APP_URL')}}admin/survey-update/{{$list->id}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" placeholder="Description" value="" required="">{{$jobdetail[0]->description}}</textarea>
                  </div>
                  </div>
