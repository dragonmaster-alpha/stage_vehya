          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="add-testimonial" class="btn btn-success" style="float:right;">Add Testimonial</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$list['name']}}</td>
                    <td>{{$list['country']}}</td>
                    <td><img src="{{env('APP_URL').'public/uploads/image/'}}{{$list['testimonial_image']}}" width="50"></td>
                     <td>
                    <a href="testimonial-list-show/{{$list['id']}}"><button class="btn btn-info"><i class="fas fa-edit"></i></button></a>
...
function a(id){
    var r = confirm("Are you sure ?");
         if (r == true) {
             location.replace("{{env('APP_URL')}}admin/testimonial-list/"+id)
         } else {
            }
}
</script>
