        ...
        <div class="row mb-2">
          <div class="col-sm-4">
            <ul class="nav nav-pills">
                  <li class="nav-item"><a  href="{{env('APP_URL')}}vendors/user-profile" class="nav-link active">Reset Password</a></li>
             </ul>
          </div>
        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Vehicle Type</label>
                     ...
                     <input type="radio" name="vehicle_type" {{$list->vehicle_type == 'Truck' ? "checked" : ""}} value="Truck" required="">Truck&ensp;&ensp;
